        ...
        <div class="login Login_margin">
          <form class="contact_us contact_line">
            <div class="middle_inputs">
              ...
              <div class="text-center sign_new sign_button" style={{marginTop:"63px",display:"inherit"}}>
               <Link to="/Jobs">
                  <button type="button" class="button-contact common_btn jobs hire">
                      <img src={AppImages.tick}  width="15px"></img>
                      Hire
                  </button>
                  </Link>
              </div>
...
export default JobsEntertainer1;